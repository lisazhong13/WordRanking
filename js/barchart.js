class BarChart {
    ...
    updateChart(country = this.selectedCountry) {
        console.log(`BarChart: Updating chart for ${country}`);
        ...
        this.currentUniversities = universities.slice(start - 1, end);

        console.log(`BarChart: Displaying universities from rank ${start} to ${end}:`, this.currentUniversities);
        ...
        // Update chart title
        this.chart.options.plugins.title.text = `Top Universities in ${country} (Rank ${start}-${end})`;
